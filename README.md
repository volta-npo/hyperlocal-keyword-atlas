...
# 📣 Hyperlocal Keyword Atlas

### A keyword research framework for neighborhoods, not national search markets.
...
**Marketing & Content** · **Repo 28/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/28-hyperlocal-keyword-atlas/) · [Report an issue](https://github.com/volta-npo/28-hyperlocal-keyword-atlas/issues) · [Volta](https://voltanpo.org)
...
**Hyperlocal Keyword Atlas** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps SEO students improving discoverability turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Keyword tools are built for scale and paid subscriptions. Local businesses need nearby intent.

### The niche

Local SEO strategy for small service businesses.

### North-star metric

`pages/posts targeting validated local intent`
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Neighborhood term map"]
        M2["Service-intent matrix"]
        M3["Competitor SERP notes"]
        M4["Content brief generator"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Hyperlocal Keyword Atlas
...
|---|---|
| **Domain workbench** | A purpose-built keyword atlas interface for a keyword research framework for neighborhoods, not national search markets. |
...
|---:|---|---|
| 1 | **Neighborhood term map** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Service-intent matrix** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Competitor SERP notes** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Content brief generator** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
```bash
git clone https://github.com/volta-npo/28-hyperlocal-keyword-atlas.git
cd 28-hyperlocal-keyword-atlas
npm test
npm start
```
