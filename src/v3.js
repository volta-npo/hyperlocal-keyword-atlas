export const v3 = {
    "productName": "Hyperlocal Keyword Atlas",
    "productTier": "release",
    ...
    "capabilities": [
        "Domain-specific workbench: Neighborhood Keyword Atlas",
        "Operational table: Keyword candidates",
    ...
    "releaseChecklist": [
        ...
        "Intent Coverage reaches production threshold",
        "Evidence Confidence is documented with evidence",
        "Brief Readiness has no unresolved blocker",
        "Keyword CSV verified",
        "SEO brief verified",
        "Title/meta pack verified"
    ],
    "operations": [
